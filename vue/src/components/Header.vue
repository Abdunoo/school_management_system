...
<template>
  <header class="bg-white border-b px-4 sm:px-6 py-2 rounded-b-3xl">
    <div class="flex items-center justify-between ">
      ...
      <div class="flex items-center space-x-4 ">
        <button class="hidden md:flex p-2 hover:bg-gray-100 rounded-full">
          <BellIcon class="w-6 h-6 text-gray-600" />
        </button>
        <button class="flex items-center space-x-2 hover:bg-gray-100 rounded-lg px-3 py-2">
          <UserCircleIcon class="w-6 h-6 text-gray-600" />
          <span class="hidden md:flex text-sm text-gray-700">Admin</span>
        </button>
      </div>
    </div>
  </header>
